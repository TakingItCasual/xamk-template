...
%\cmdinput{test.txt}[title={Some command-line commands},every listing line={\$\#>\ }]
...
\begin{code}[firstnumber=11]{python}[title={Some Python code with syntax highlighting}]
...
\end{code}
% Alternatively, import content from file
%\codeinput{thesis-abstract.tex}[firstline=9,lastline=13]{latex}[title={Part of the thesis abstract}]
