\section{List of Options, Commands, and Environments}
...
% Provided with the minted class option. Minted options (e.g. starting line number or font size) are specified before the language, while TCBListing options (e.g. title or label) are specified after the language. Supported languages can be seen with the command "pygmentize -L lexers", or from https://pygments.org/docs/lexers/.
\end{code}
