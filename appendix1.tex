...
% Provided with the minted class option. Minted settings (starting line number, font size, etc.) can be specified before the language, while TCBListing settings (title, label, etc.) can be specified after the language. Supported languages can be seen with the command "pygmentize -L lexers", or from https://pygments.org/docs/lexers/.
